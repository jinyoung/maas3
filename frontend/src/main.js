...
pluralCaseList.push( {plural: "feedbacks", pascal: "Feedback"} )
pluralCaseList.push( {plural: "assistanceRequests", pascal: "AssistanceRequest"} )

pluralCaseList.push( {plural: "passengerLocations", pascal: "PassengerLocation"} )
pluralCaseList.push( {plural: "driverNotifications", pascal: "DriverNotification"} )

pluralCaseList.push( {plural: "assistanceStatistics", pascal: "AssistanceStatistics"} )
