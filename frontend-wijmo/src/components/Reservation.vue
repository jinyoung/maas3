            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">ReservationId</div>
                        <String label="입력하세요." v-model="value.reservationId" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
...
import ReservationBase from '../components/ReservationBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/reservations";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "reservations."+ me.value.reservationId +".get"
